...
const mock = [
  {
    media: 'https://assets.faviofigueroay.com/backgrounds/img19.jpg',
    title: 'Sales philosophy and future',
    time: '2:00 PM - 5:00 PM',
    location: 'Via E. Gola 4, 20147 Milan, Italy',
  },
  {
    media: 'https://assets.faviofigueroay.com/backgrounds/img5.jpg',
    title: 'Introduction to design thinking',
    time: '11:30 AM - 1:00 AM',
    location: 'Via Venini 33, 20150 Milan Italy',
  },
  {
    media: 'https://assets.faviofigueroay.com/backgrounds/img20.jpg',
