  ...
  return (
    <Box>
      <Box marginBottom={4}>
        ...
        >
          ¿Necesita ayuda para elegir un niño para apadrinar?
        </Typography>
        <Typography
          variant="h6"
          align={'center'}
          ...
          data-aos={'fade-up'}
        >
          Nos encantaría ponértelo fácil. Simplemente responda algunas preguntas y obtenga coincidencias: ¡su viaje de patrocinio está a solo un clic de distancia!
        </Typography>
      </Box>
